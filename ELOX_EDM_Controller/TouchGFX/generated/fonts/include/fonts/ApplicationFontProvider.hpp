...
struct TypographyFontIndex
{
    ...
    static const touchgfx::FontId VERY_LARGE = 3;    // verdana_100_4bpp
    static const touchgfx::FontId DISPLAY = 1;       // verdana_20_4bpp
    static const touchgfx::FontId MODE = 1;          // verdana_20_4bpp
    static const touchgfx::FontId KEYBOARD = 1;      // verdana_20_4bpp
    static const touchgfx::FontId TYPOGRED_TEXT = 3; // verdana_100_4bpp
